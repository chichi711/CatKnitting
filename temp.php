                        ...
                        <form method="post" class="form-horizontal">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input id="userPwd" name="userPwd" type="text" placeholder="" class="form-control input-md">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-4 control-label" for="lastName2">再次輸入密碼 :</label>
                                    <div class="col-md-9">
                                        <input id="rePwd" name="rePwd" type="text" placeholder="" class="form-control input-md">
                                    </div>
                                </div>
                                <div class="form-group">
